                ...
                if (j) {
                    ...
                    var l = !1,
                        m = function() {
                            ...
                            console.log("from:"+g.options.from);
                            var b = {
                                from: g.options.from,
                                to: g.options.to,
                                step: g.options.step,
                    ...
                    },true), i.$observe(i.ngDisabled, function(a) {
...
function(a) {
    ...
    a.module("ngSlider").run(["$templateCache", function(a) {
        a.put("ng-slider/slider-bar.tmpl.html", '<span ng-class="mainSliderClass" id="{{sliderTmplId}}"><table><tr><td><div class="jslider-bg"><i class="l"></i><i class="r"></i><i class="v"></i><i class="p"></i><i class="s"></i><i class="f"></i></div><div class="jslider-pointer"></div><div class="jslider-pointer jslider-pointer-to"></div><div class="jslider-label"><span>{{from|currency:"&#8377;"}}</span></div><div class="jslider-label jslider-label-to"><span>{{to|currency:"&#8377;"}}</span></div><div class="jslider-value"><span></span></div><div class="jslider-value jslider-value-to"><span></span>{{options.dimension}}</div><div class="jslider-scale" id="{{sliderScaleDivTmplId}}"></div></td></tr></table></span>')
    }])
}(window.angular);
