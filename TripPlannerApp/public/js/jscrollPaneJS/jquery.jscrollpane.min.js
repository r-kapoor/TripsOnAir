...
//console.log("children height:"+pane.children().height());
                ...
                else if(elem.attr("id")=="flightPanel")
                {
                    transcludeScrollHeight = $("#transcludeFlightPanel")[0].scrollHeight;
                    //console.log("withID transcludeFlightPanel:"+transcludeScrollHeight);
                }
                else if(elem.attr("id")=="trainPanel")
                {
                    transcludeScrollHeight = $("#transcludeTrainPanel")[0].scrollHeight;
                    //console.log("withID transcludeTrainPanel:"+transcludeScrollHeight);
                }
                else if(elem.attr("id")=="busPanel")
                {
                    transcludeScrollHeight = $("#transcludeBusPanel")[0].scrollHeight;
                    //console.log("withID transcludeBusPanel:"+transcludeScrollHeight);
                }
                else if(elem.attr("id")=="cabOperatorPanel")
                {
                    transcludeScrollHeight = $("#transcludeCabOperatorPanel")[0].scrollHeight;
                    //console.log("withID transcludeCabOperatorPanel:"+transcludeScrollHeight);
                }
                else if(elem.attr("id")=="reorderDestPanel")
                {
                    transcludeScrollHeight = $("#transcludeReorderPanel")[0].scrollHeight;
                    //console.log("withID transcludeReorderPanel:"+transcludeScrollHeight);
                }
                else if(elem.attr("id")=="placesPanel")
                {
                    transcludeScrollHeight = $("#transcludePlacesPanel")[0].scrollHeight;
                    //console.log("withID transcludePlacesPanel:"+transcludeScrollHeight);
                }
                else if(elem.attr("id")=="hotelsPanel")
                {
                    transcludeScrollHeight = $("#transcludeHotelsPanel")[0].scrollHeight;
                    //console.log("withID transcludeHotelsPanel:"+transcludeScrollHeight);
                }
                else
                {
